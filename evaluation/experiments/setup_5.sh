...
sed -i -e "s/BUCKET_SIZE_SET_BY_EXPERIMENT/440/g" ${DIR}/evaluation.conf

# Increase dataset by 1.5MB
./create_dataset.sh data/restaurant.csv ${DIR}/restaurant.csv 1.5
