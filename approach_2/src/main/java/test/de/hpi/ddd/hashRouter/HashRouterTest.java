package test.de.hpi.ddd.hashRouter;
...
public class HashRouterTest {
    ...
    public void testBuckets() {
        ...
        for (int i = 0; i < blockingKeys.size(); i++) {
            Assert.assertTrue(buckets.get(i).equals(buckets.get(i + 50)));
            Assert.assertTrue(buckets.get(i).equals(buckets.get(i + 100)));
            Assert.assertTrue(buckets.get(i).equals(buckets.get(i + 150)));
        }
